            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="col-span-1">
                  ...
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <input
                      ...
                      className="block w-full pr-10 bg-slate-700/50 border border-slate-600 text-white rounded-xl focus:ring-red-500 focus:border-red-500 sm:text-sm py-3 transition-all duration-300 outline-none"
                      placeholder="مثلاً: ۳ ماه پیش / ۱۴۰۲/۰۵/۱۲ / هیچوقت"
                ...
                <div className="col-span-1">
                  ...
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <input
                      ...
                      required
                      className="block w-full pr-10 bg-slate-700/50 border border-slate-600 text-white rounded-xl focus:ring-red-500 focus:border-red-500 sm:text-sm py-3 transition-all duration-300 outline-none"
                      placeholder="سالم / دارای حساسیت خاص ..."
              ...
              <div className="pt-4">
                <motion.button
                  ...
                  type="submit"
                  disabled={loading}
                  className={`w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-lg text-lg font-bold text-white transition-all duration-300 ${
                    loading ? 'bg-red-700/50 cursor-not-allowed' : 'bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 shadow-red-600/30 hover:shadow-red-500/50'
                  }`}
                >
                  {loading ? (
              ...
              {message && (
                <motion.div
                  ...
                  className={`mt-6 p-4 rounded-xl flex items-center gap-3 ${
                    success ? 'bg-green-900/40 border border-green-500/50 text-green-200' : 'bg-red-900/40 border border-red-500/50 text-red-200'
                  }`}
                >
                  {success && <FaCheckCircle className="h-5 w-5 text-green-400 flex-shrink-0" />}
